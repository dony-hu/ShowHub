      ...
      <div className="pn-hero-container">
        <div className="pn-hero-content">
          ...
          <p className="pn-hero-subtitle">
            面向企业与政务 Agent 的内网地图、地址与空间智能底盘
          </p>
          <p className="pn-hero-description">
            面向企业专网、政务内网和高安全隔离环境，提供可私有化落地的地图底座、地址大模型、私域知识图谱、调度与应急 Agent，<br />
        ...
        <div className="pn-hero-visual">
          <div className="hero-panel">
            ...
            <div className="hero-panel-row"><span>Agent 能力</span><strong>调度 / 研判 / 应急</strong></div>
          </div>
